...
import curso.nelioalves.cursomc.services.ClienteService;
...
public class ClienteResource {
	...
	public ResponseEntity<Page<ClienteDTO>> findPage(
		...
		Page<ClienteDTO> lista = service.findPage(page, linesPerPage, orderBy,
				direction).map(obj -> new ClienteDTO(obj));
